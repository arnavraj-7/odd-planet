...
export function WorkPinned() {
  ...
  return (
    <section id="work" ref={sectionRef} className="relative">
      <div
        ref={innerRef}
        className="sticky top-0 flex h-screen min-h-[min(600px,100vh)] flex-col overflow-hidden pt-[calc(var(--op-header)+clamp(6px,1vw,14px))] pb-[clamp(14px,1.8vw,22px)]"
      >
        <div className="mx-auto flex w-full max-w-[1400px] shrink-0 flex-wrap items-end justify-between gap-x-10 gap-y-2.5 px-gutter">
          <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1">
            <div className="op-eyebrow">Our work</div>
        ...
        <div className="mt-[clamp(12px,1.8vw,22px)] mb-[clamp(10px,1.4vw,18px)] flex flex-1 items-center overflow-hidden">
          <div
            ref={scrollerRef}
